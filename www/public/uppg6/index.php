...
<form action="result.php" method="post">
    ...
    <label>Hur lång är Ida?<br>  
        <input type="radio" name="qFive" value="banan">3 bananer<br>
        <input type="radio" name="qFive" value="riskorn">4 riskorn<br>
        <input type="radio" name="qFive" value="twntwr">Twin towers<br><br>
    </label>
    <label>Hur söt är Abed?<br>  
        <input type="radio" name="qSix" value="cutest">Sötaste varelsen någonsin<br>
        <input type="radio" name="qSix" value="noCute">Abed är no cute<br>
        <input type="radio" name="qSix" value="lite">Bara lite<br><br>
    </label>
